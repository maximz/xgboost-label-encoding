#!/usr/bin/env python
#
# xgboost_label_encoding documentation build configuration file, created by sphinx-quickstart.
#
...
project = "xgboost-label-encoding"
...
version = xgboost_label_encoding.__version__
# The full version, including alpha/beta/rc tags.
release = xgboost_label_encoding.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(xgboost_label_encoding.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "xgboost_label_encoding/%s#L%d-L%d" % find_source()
    except Exception:
...
html_theme_options = {
    ...
    "github_user": "maximz",
    "github_repo": "xgboost-label-encoding",
    "github_banner": True,
    "github_type": "star",
    "show_related": False,
    "note_bg": "#FFF59C",
...
htmlhelp_basename = "xgboost_label_encodingdoc"
...
latex_documents = [
    (
        master_doc,
        "xgboost_label_encoding.tex",
        "xgboost-label-encoding Documentation",
        author,
        "manual",
    ),
]
